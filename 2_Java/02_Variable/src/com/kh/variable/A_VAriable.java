...
//		variable.printValueTest();
	...
	public void printValue() {
		...
		// 원의 둘레와 원의 넓이를 출력하시오.
		// 원의 둘레 = 반지름 X 2 X 3.131592...
		// 원의 넓이 = 반지름 X 반지름 X3.141592...
...
//		bNum = 128; 1byte는 127까지만 되므로 에러 발생! -> 오버플로우(overflow)
		...
		long iNum = 9223372837283458L; // 8byte - 숫자 뒤에 L(ㅣ)을 입력
		...
		// 실제 더이터 값은 힙 메모리에 저장하고,
		// 스텍 메모리의 변수 공간에는 실제 변수값이 저장된 힙 메모리의 위치값을 저장
		String name = "장영태";

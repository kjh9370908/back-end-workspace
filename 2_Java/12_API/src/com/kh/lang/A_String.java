...
public class A_String {
	...
	public void method1() {
		...
		System.out.println("str1.epuals(str2) " + (str1.equals(str2))); // ture
		System.out.println("str3.epuals(str4) " + (str3.equals(str4))); // ture
		System.out.println("str1.epuals(str3) " + (str1.equals(str3))); // ture

	
	}
	
	// String 클래스에서 제공되는 메서드
	public void method2() {
		...
		//    substring(ont beginIndex, int endIndex) : String
		// 	  문자열의 beginIndex부터 endIndex - 1 가지 (endIndex가 생략되면 끝까지)
		// 	  의 문자열을 새로 생성해서 리턴
		...
		// 	  문자열에서 old 문자를 new 문잘 변경된 새로운 문자열을 생성해서 리턴
	...
	public void method3() {
		...
		// 3. delete(int strart, int end) : StringBuilder
	...
	public void method4() {
		...
		String str = "HTML,CSS,JavaScript,MySQL,Java,JDBC,Servler,JSP,JQuery,MyBatis,Spring,React";

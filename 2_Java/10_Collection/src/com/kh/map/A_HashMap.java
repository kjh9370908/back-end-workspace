...
public class A_HashMap {
	...
	public void method2() {
		...
		map.put("웨하스", new Snack("치즈", 24));
		map.put("웨하스", new Snack("딸기", 25));
		map.put("고래밥", new Snack("양념치킨", 173));
		map.put("자유시간", new Snack("아몬드", 232));
		map.put("칸쵸", new Snack("딸기 요거트", 214));
		map.put("홈런볼", new Snack("초코", 361));
		map.put("스윙칩", new Snack("볶음고추", 155));
		map.put("나쵸", new Snack("치즈", 100));
		...
		// 모든 Entry 객체 삭제
		map.clear();
		System.out.println("비어있는지? " + mam.isEmpty;

...
-- 사원의 사번, 사원명 ,급여,  연봉 조회 (정렬 연봉 높은 순) desc 
 SELECT salary_calc(emp_id), emp_id, emp_name, salary
 FROM employee
...
INSERT INTO product(pname, brand, price, stock)
	VALUES ('갤럭시Z 플립4', '삼성', 178000, 10);
INSERT INTO product(pname, brand, price, stock)
	VALUES ('아이폰15', '애플', 125000, 20);
